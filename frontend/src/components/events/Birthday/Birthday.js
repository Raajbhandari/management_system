    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 text-white">
      ...
      <nav className="bg-gray-900 shadow-lg fixed top-0 w-full z-50">
        <div className="container mx-auto p-4 flex justify-between items-center">
          ...
          <div className="flex items-center">
            <a href="/" className="text-gray-400 hover:text-pink-500 transition duration-300 mr-6">Home</a>
            <button
              onClick={() => navigate('/vendor-events')}
      ...
      <section className="relative pt-24 text-center">
        <div className="container mx-auto p-8">
          <h2 className="text-5xl font-bold mb-4 text-pink-400">Birthday Event</h2>
          <p className="text-lg mb-8 text-gray-300">Explore the fun and elegance of our birthday packages.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
            <img
              ...
              alt="Birthday 1"
              className="rounded-lg shadow-lg transition duration-300 transform hover:scale-105 w-full h-64 object-cover"
            />
            <img
              src="https://images.pexels.com/photos/7180612/pexels-photo-7180612.jpeg?auto=compress&cs=tinysrgb&w=600"
              alt="Birthday 2"
              className="rounded-lg shadow-lg transition duration-300 transform hover:scale-105 w-full h-64 object-cover"
            />
            <img
              src="https://images.pexels.com/photos/20016143/pexels-photo-20016143/free-photo-of-white-birthday-cake.jpeg?auto=compress&cs=tinysrgb&w=600"
              alt="Birthday 3"
              className="rounded-lg shadow-lg transition duration-300 transform hover:scale-105 w-full h-64 object-cover"
            />
            <img
              src="https://media.istockphoto.com/id/1405876768/photo/decoration-for-a-childrens-party.webp?s=1024x1024&w=is&k=20&c=HS-5InVtFqhz-lFI0uCmVkXR9ECIA3hpyl-3eJEY5gs="
              alt="Birthday 4"
              className="rounded-lg shadow-lg transition duration-300 transform hover:scale-105 w-full h-64 object-cover"
            />
          </div>
          ...
          <h2 className="text-3xl font-bold mt-12 mb-6 text-pink-400">Types of Birthday</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Children’s Birthday */}
            <div className="relative bg-cover bg-center rounded-lg shadow-lg h-72 transform transition duration-300 hover:scale-105"
              style={{ backgroundImage: 'url(https://frillx.com/cdn/shop/products/first-birthday-pastel-balloon-decoration-pack-of-64-pcs-diy-kit-kids-birthday-137167_360x.jpg?v=1646290475)' }}>
              <div className="absolute inset-0 bg-black bg-opacity-60 rounded-lg flex flex-col justify-center items-center text-center p-4">
                <h3 className="text-2xl font-bold text-white mb-2">Children’s Birthday Party</h3>
                <p className="text-gray-300 mb-4">
                  A fun-filled day with themed games, activities, and entertainment designed for kids.
                </p>
                <button
                  onClick={() => handleDetailRedirect('children-birthday')}
            ...
            {/* Milestone Birthday */}
            <div className="relative bg-cover bg-center rounded-lg shadow-lg h-72 transform transition duration-300 hover:scale-105"
              style={{ backgroundImage: 'url(https://www.emrgmedia.com/wp-content/uploads/2023/06/pexels-nataliya-vaitkevich-7859956.jpg.webp)' }}>
              <div className="absolute inset-0 bg-black bg-opacity-60 rounded-lg flex flex-col justify-center items-center text-center p-4">
                <h3 className="text-2xl font-bold text-white mb-2">Milestone Birthday Party</h3>
                <p className="text-gray-300 mb-4">
                  A grand celebration marking a significant life event, like turning 30, 50, or beyond.
                </p>
                <button
                  onClick={() => handleDetailRedirect('milestone-birthday')}
                  className="bg-pink-500 px-4 py-2 rounded-lg hover:bg-pink-700 transition text-white"
                >
                  More Details
                </button>
            ...
            <div className="relative bg-cover bg-center rounded-lg shadow-lg h-72 transform transition duration-300 hover:scale-105"
              style={{ backgroundImage: 'url(https://blog.venuelook.com/wp-content/uploads/2020/09/Next-Camping-Destination.webp)' }}>
              <div className="absolute inset-0 bg-black bg-opacity-60 rounded-lg flex flex-col justify-center items-center text-center p-4">
                <h3 className="text-2xl font-bold text-white mb-2">Destination Birthday Party</h3>
                <p className="text-gray-300 mb-4">
                  A celebration at a travel location, combining adventure and relaxation for a memorable getaway.
                </p>
                <button
                  onClick={() => handleDetailRedirect('destination-birthday')}
                  className="bg-pink-500 px-4 py-2 rounded-lg hover:bg-pink-700 transition text-white"
                >
                  More Details
                </button>
