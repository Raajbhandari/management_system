...
const Childrenbirthday = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 p-6">
      ...
      {/* Navbar */}
      <nav className="bg-gray-800 shadow-lg fixed top-0 w-full h-16 z-50">
        <div className="container mx-auto p-4 flex justify-between items-center">
      ...
      <div className="mb-6 mt-20">
        <img
          ...
          className="rounded-lg w-full h-96 object-cover mt-16" // Added margin-top for the image
        />
        <h1 className="text-4xl font-bold text-white mt-4">Children Birthday</h1>
        <p className="text-lg text-gray-300 mt-2 mb-4">
          A fun-filled day with themed games, activities, and entertainment designed for kids.
        </p>
        <div className="text-2xl font-bold text-pink-400 mb-4"> Rs.{5000*50}</div>
        <div className="flex space-x-4 mb-6">
          {/* Book Now Button */}
          <button
            className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 flex items-center"
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-md mb-6">
        <h2 className="text-2xl font-semibold text-pink-400 mb-4">Birthday Customization</h2>
        <div className="mb-4">
          <label className="block text-lg font-medium text-gray-300 mb-2">Decoration:</label>
          <select
            value={decoration}
            onChange={(e) => setDecoration(e.target.value)}
            className="w-full p-2 border border-gray-600 rounded-lg bg-gray-900 text-gray-300"
          >
            <option value="Standard">Standard -  Rs.{1000*50}</option>
            <option value="Premium">Premium -  Rs.{2500*50}</option>
            <option value="Luxury">Luxury -  Rs.{5000*50}</option>
        ...
        {/* Lighting Option */}
        <div className="mb-4">
          <label className="block text-lg font-medium text-gray-300 mb-2">Lighting:</label>
          <select
            value={lighting}
            onChange={(e) => setLighting(e.target.value)}
            className="w-full p-2 border border-gray-600 rounded-lg bg-gray-900 text-gray-300"
        ...
        {/* Catering Option */}
        <div className="mb-4">
          <label className="block text-lg font-medium text-gray-300 mb-2">Catering:</label>
          <select
            value={catering}
            onChange={(e) => setCatering(e.target.value)}
            className="w-full p-2 border border-gray-600 rounded-lg bg-gray-900 text-gray-300"
          >
            <option value="Buffet">Buffet - Rs.{50 * 2000}</option>
            <option value="A La Carte">A La Carte - Rs.{3500 * 50}</option>
            <option value="Luxury">Luxury Dining - Rs.{5000 * 50}</option>
          </select>
        </div>
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-md">
        <h2 className="text-2xl font-semibold text-pink-400 mb-4">Guest List</h2>
        <div className="flex mb-4">
          <input
            type="text"
            placeholder="Add guest name"
            value={guest}
            onChange={(e) => setGuest(e.target.value)}
            className="p-2 border border-gray-600 rounded-lg w-full mr-2 bg-gray-900 text-gray-300"
          />
          <button
            onClick={handleAddGuest}
            className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-700"
